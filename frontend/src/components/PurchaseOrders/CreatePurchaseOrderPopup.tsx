...
const CreatePurchaseOrderPopup: React.FC<CreatePurchaseOrderPopupProps> = ({
  ...
  const fetchAutoGeneratedPoNumber = async () => {
    ...
    try {
      const res = await api.get('/purchases/generate-po-number');
          ...
          <form onSubmit={handleSubmit} className="space-y-4 p-5">
                ...
                <div className="mt-3 border rounded-md">
                  ...
                  <div className="max-h-40 overflow-y-auto">
                    {selectedProducts.map((item, i) => (
                      <div key={i} className="flex justify-between items-center px-3 py-2 border-b last:border-b-0">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
              ...
              <div>
                ...
                <label className="block border-2 border-dashed border-gray-300 rounded-lg p-4 text-center cursor-pointer hover:border-gray-400">
                  <Upload className="mx-auto text-gray-400 mb-2" size={28} />
                  <span className="text-sm text-blue-600">Click to upload</span>
                  <input type="file" multiple className="hidden" onChange={handleFileChange} />
                  <p className="text-xs text-gray-500 mt-1">Max 10MB each</p>
                </label>
