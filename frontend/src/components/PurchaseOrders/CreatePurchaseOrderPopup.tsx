...
const CreatePurchaseOrderPopup: React.FC<CreatePurchaseOrderPopupProps> = ({
  ...
  const [poNumberLoading, setPoNumberLoading] = useState(false); // Separate loading state for PO number
  ...
  const fetchData = async () => {
    ...
    try {
      ...
      // Fetch PO number after data is loaded
  ...
  const fetchAutoGeneratedPoNumber = async () => {
    setPoNumberLoading(true); // Set loading state when fetching
    try {
      ...
      setPoNumberLoading(false); // Always stop loading after fetch
    }
  };
            ...
            <div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <input
                    type="text"
                    value={poNumberLoading ? 'Loading...' : formData.poNumber || 'Generating...'}
